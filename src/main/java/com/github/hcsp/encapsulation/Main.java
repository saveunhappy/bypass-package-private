...
import com.github.blindpirate.extensions.CaptureSystemOutputExtensionFactory;
...
public class Main {
    ...
    public static Object createCaptureSystemOutputExtension() {
        ...
        return CaptureSystemOutputExtensionFactory.createCaptureSystemOutputExtension();
    }
}
