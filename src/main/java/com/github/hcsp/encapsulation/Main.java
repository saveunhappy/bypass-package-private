...
import com.github.blindpirate.extensions.BridgeCaptureSystemOutputExtension;
...
public class Main {
    ...
    public static Object createCaptureSystemOutputExtension() {
        ...
        return BridgeCaptureSystemOutputExtension.getCaptureSystemOutputExtensionInstance();
    }
}
