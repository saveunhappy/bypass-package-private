...
import com.github.blindpirate.extensions.GetCaptureSystemOutputExtension;
...
public class Main {
    ...
    public static Object createCaptureSystemOutputExtension() {
        ...
        GetCaptureSystemOutputExtension getCaptureSystemOutputExtension = new GetCaptureSystemOutputExtension();
        return getCaptureSystemOutputExtension.createCaptureSystemOutputExtension();
    }
}
